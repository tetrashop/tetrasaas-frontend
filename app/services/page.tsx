    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-600 text-lg max-w-3xl mx-auto">
          مجموعه کامل سرویس‌های هوش مصنوعی پلتفرم TetraSaaS برای کسب‌وکارها،
          توسعه‌دهندگان و محققان
        </p>
      </div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div
                  className={`px-3 py-1 rounded-full text-sm font-medium ${service.status === "فعال" ? "bg-green-100 text-green-800" : service.status === "در حال توسعه" ? "bg-blue-100 text-blue-800" : "bg-amber-100 text-amber-800"}`}
                >
                  {service.status}
                </div>
              </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-bold mb-2">
              🚀 شروع استفاده از API ها
            </h2>
            <p className="text-gray-300">
              تمام سرویس‌های ما از طریق REST API در دسترس هستند. کلید API رایگان
              دریافت کنید.
            </p>
          </div>
